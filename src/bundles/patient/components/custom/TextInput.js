...
const useStyles = makeStyles((theme) => ({
  ...
  underline: {
    ...
    "&:after": {
      borderBottom: '2px solid #6A6981' // make white
    }
...
export default function CustomizedInputBase({ change, disableUnderline }) {
  ...
  const showEnter = (<IconButton className={classes.roundedButton}>
                        <Arrow className={classes.roundedIcon} />
                    </IconButton>)

  const showClose = ( <IconButton> <CloseIcon /> </IconButton> )
  ...
  return (
    <FormControl fullWidth className={classes.margin} >
      <Input
        ...
        endAdornment={
          <InputAdornment style={{ marginRight: 20, marginBottom: 5 }} position='end'>
